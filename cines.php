...
<html lang="en">
        ...
        <body>
           ...
           <ul class="menu">
            ...
            <div class="sedes">
                <div class="formatossede">
                    <div class="tipossede">
                     <img src="img/caminosInca.jpg" id="formatsede">
                     <p>
                       <br>CP Caminos del Inca
                       <br>Av. Santa Cruz 814-816
                       <br>2D, REGULAR, CON VACUNA, 3D
                     </p>
                    </div>
                        <div class="tipossede">
                        <img src="img/cantoGrande.png" id="formatsede">
                        <p>
                          <br>CP Arequipa Mall Plaz
                          <br>Av. Ejercito 793 Cayma
                          <br>2D, REGULAR, SIN VACUNA, CON VACUNA
                        </p>
                       </div>
                       <div class="tipossede">
                               <img src="img/centro.jpg" id="formatsede">
                               <p>
                                      <br> CP Arequipa Paseo Central
                                      <br>Av. Arturo Ibañez S/N,
                                      <br>2D, DOB, CON VACUNA, REGULAR
                               </p>
                       </div>
                </div>
            </div>
            <div class="sedes">
                <div class="formatossede">
                  <div class="tipossede">
                               <img src="img/centroCivico.jpg" id="formatsede">
                               <p>
                                       <br>CP Centro Civico
                                       <br>Av. Inca Garcilazo de la Vega
                                       <br>2D, REGULAR, CON VACUNA, 3D
                               </p>
                       </div>
                       <div class="tipossede">
                        <img src="img/chiclayo.jpg" id="formatsede">
                        <p>
                                <br>CP Chiclayo Mall Aventura
                                <br>Av. Panamericana 639 -Int 01
                                <br>2D, REGULAR, SIN VACUNA, CON VACUNA
                        </p>
                       </div>
                       <div class="tipossede">
                        <img src="img/chiclayoRp.jpg" id="formatsede">
                        <p>
                                <br>CP Chiclayo Real Plaza
                                <br>Av. Miguel de Cervantes 300
                                <br>2D, DOB, CON VACUNA, REGULAR
